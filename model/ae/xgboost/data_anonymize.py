...
def _generate_strings(num_values=1000, length=16):
    ...
    for i in range(num_values):
        ...
        if i % 10000 == 0:
            print('{}% of the strings already generated!'.format((i*100.0)/num_values))
    return list(gen_set)
...
def apply_mappings(filepaths, mappings, column, re_column2=None):
    ...
    for fpath in filepaths:
        ...
        output_dir = output_dir.replace('Raw', 'Anonymized') #Save output in Anonymized folder
...
# ================================================================================
    ...
    # RE With Dates
    ROOT_DIR = '/home/ec2-user/SageMaker/CMSAI/modeling/tes/data/anonymize/REWithDates/Data/'
    RAW_DIR = os.path.join(ROOT_DIR, 'Raw')
    OUTPUT_DIR = os.path.join(ROOT_DIR, 'Anonymized')
