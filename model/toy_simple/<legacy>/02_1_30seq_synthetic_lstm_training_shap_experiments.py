...
model_save_path = "./output/for-meeting-exp/unstable/1/{}/{}/models/weights/model_{}.pkl".format(
    seq_len, model_name, "{}"
)
model_save_all_path = "./output/for-meeting-exp/unstable/1/{}/{}/models/all/model_{}.pkl".format(
    seq_len, model_name, "{}"
)
shap_save_path = "./output/for-meeting-exp/unstable/1/{}/{}/shap/{}_shap_{}.pkl".format(
    seq_len, model_name, "{}", "{}"
