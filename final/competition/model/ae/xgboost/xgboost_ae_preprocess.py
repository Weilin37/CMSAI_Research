...
if __name__ == "__main__":
    ...
    SPLITS_FNAMES = OrderedDict(
        {
            "train": ["final_allvocab_x_train.npy", "final_allvocab_y_train.npy"],
    ...
    S3_OUTPUT_DIR = (
        "s3://cmsai-mrk-amzn/CSVModelInputs/Tes/models/ae/final-global/data/"
    )
